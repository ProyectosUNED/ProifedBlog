...
VP_Security::instance()->whitelist_function('vp_dep_is_category');

function vp_dep_is_category($value)
{
    if($value === 'category')
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('jeg_video_youtube_vimeo');

function jeg_video_youtube_vimeo($value)
{
...
VP_Security::instance()->whitelist_function('jeg_video_html5');

function jeg_video_html5($value)
{
    if($value === 'html5video')
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('jeg_get_review_page');

function jeg_get_review_page()
{
    $result = array();

    $pages = get_pages(array(
        'meta_key' => '_wp_page_template',
        'meta_value' => 'template-review.php'
    ));
...
VP_Security::instance()->whitelist_function('jeg_is_image_ads');

function jeg_is_image_ads($value)
{
    if($value === 'imageads')
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('jeg_is_code_ads');

function jeg_is_code_ads($value)
{
    if($value === 'code')
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('jeg_is_google_ads');

function jeg_is_google_ads($value)
{
    if($value === 'googleads')
        return true;
    return false;
...
VP_Security::instance()->whitelist_function('jeg_is_disqus');

function jeg_is_disqus($value)
{
    if($value === 'disqus')
        return true;
    return false;
