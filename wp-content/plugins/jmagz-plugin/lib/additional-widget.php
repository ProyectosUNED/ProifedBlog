...
define('JEG_WIDGET_TEMPLATE_PATH'	, JMAGZ_PLUGIN_DIR . '/lib/widget-template/');
...
class Jeg_Facebook_Fans_Widget extends Jeg_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            'Jegtheme - Facebook Fans Widget', // Name
