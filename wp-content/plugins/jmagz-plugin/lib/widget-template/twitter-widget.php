...
<div class="jeg-twitter-container">
	...
	<div class="jeg-follow-button clearfix">
        <a href="https://twitter.com/<?php echo esc_attr( $twitter_username ); ?>" class="twitter-follow-button" data-show-count="false" data-dnt="true">Follow @<?php echo esc_attr( $twitter_username ); ?></a>
